...
public class AuroraBrunoPieters extends RecyclerView.Adapter<AuroraBrunoPieters.MyViewHolder> {
    ...
    public AuroraBrunoPieters(ArrayList<AuroraSusienChong> data, Context mContext) {
        this.dataSet = data;
