...
public class AuroraMartinMargiela extends RecyclerView.Adapter<AuroraMartinMargiela.MyViewHolder> {
    ...
    public AuroraMartinMargiela(ArrayList<AuroraSusienChong> data, Context mContext) {
        this.dataSet = data;
        ...
        holder.imageViewIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    AuroraOlivierStrelli.AddSticker(bitmap);
