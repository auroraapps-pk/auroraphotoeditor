package com.auroraapps.auroraphotoeditor.AuroraLoadingIndicatorView;
...
import com.auroraapps.auroraphotoeditor.AuroraLoadingIndicatorView.AuroraIndicator.AuroraIndicator;
import com.auroraapps.auroraphotoeditor.R;


public class AuroraAVLoadingIndicatorView extends View {

    private static final String TAG = "AVLoadingIndicatorView";

    private static final AuroraLineScaleIndicator DEFAULT_INDICATOR = new AuroraLineScaleIndicator();
    ...
    private AuroraIndicator mIndicator;
    private int mIndicatorColor;

    private boolean mShouldStartAnimationDrawable;

    public AuroraAVLoadingIndicatorView(Context context) {
        super(context);
        init(context, null, 0, 0);
    }

    public AuroraAVLoadingIndicatorView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0, R.style.AVLoadingIndicatorView);
    }

    public AuroraAVLoadingIndicatorView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr, R.style.AVLoadingIndicatorView);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public AuroraAVLoadingIndicatorView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public AuroraIndicator getIndicator() {
        return mIndicator;
    }

    public void setIndicator(AuroraIndicator d) {
        if (mIndicator != d) {
            if (mIndicator != null) {
    ...
    public void setIndicator(String indicatorName) {
        ...
        try {
            ...
            AuroraIndicator indicator = (AuroraIndicator) drawableClass.newInstance();
