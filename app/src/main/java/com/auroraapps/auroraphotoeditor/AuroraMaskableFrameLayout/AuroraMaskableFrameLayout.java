package com.auroraapps.auroraphotoeditor.AuroraMaskableFrameLayout;
...
public class AuroraMaskableFrameLayout extends FrameLayout {
    ...
    public AuroraMaskableFrameLayout(Context context) {
        super(context);
    }

    public AuroraMaskableFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        construct(context, attrs);
    }

    public AuroraMaskableFrameLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void registerMeasure() {
        final ViewTreeObserver treeObserver = AuroraMaskableFrameLayout.this.getViewTreeObserver();
            ...
            treeObserver.addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                ...
                public void onGlobalLayout() {
                    ...
                    if (!aliveObserver.isAlive()) {
                        aliveObserver = AuroraMaskableFrameLayout.this.getViewTreeObserver();
                    }
