...
public class AuroraJoeSaba extends RecyclerView.Adapter<AuroraJoeSaba.MyViewHolder> {
    ...
    public AuroraJoeSaba(ArrayList<AuroraSusienChong> data, Context mContext) {
        this.dataSet = data;
