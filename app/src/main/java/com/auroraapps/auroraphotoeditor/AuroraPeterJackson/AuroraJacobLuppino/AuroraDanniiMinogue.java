...
public class AuroraDanniiMinogue extends RecyclerView.Adapter<AuroraDanniiMinogue.MyViewHolder> {
    ...
    public AuroraDanniiMinogue(ArrayList<AuroraSusienChong> arrayList, Context mcContext) {
        ...
        try {
            ...
            if (files != null) {
                for (String file : files) {
                    arrayListPrev.add(new AuroraSusienChong("lighten/prev/" + file));
                }
            }
        } catch (IOException e) {
            e.printStackTrace();
