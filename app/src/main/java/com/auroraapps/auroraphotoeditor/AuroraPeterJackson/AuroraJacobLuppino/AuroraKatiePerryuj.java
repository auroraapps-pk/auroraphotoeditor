...
public class AuroraKatiePerryuj extends RecyclerView.Adapter<AuroraKatiePerryuj.MyViewHolder> {

    ArrayList<AuroraSusienChong> arrayList;
    ArrayList<AuroraSusienChong> arrayListPrev;
    Context mContext;

    public AuroraKatiePerryuj(ArrayList<AuroraSusienChong> arrayList, Context mcContext) {
        ...
        try {
            ...
            if (files != null) {
                for (String file : files) {
                    arrayListPrev.add(new AuroraSusienChong("softlight/prev/" + file));
                }
            }
        } catch (IOException e) {
            e.printStackTrace();
