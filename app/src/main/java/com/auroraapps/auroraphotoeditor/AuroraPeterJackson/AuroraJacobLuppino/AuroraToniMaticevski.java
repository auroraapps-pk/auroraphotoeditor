...
public class AuroraToniMaticevski extends RecyclerView.Adapter<AuroraToniMaticevski.MyViewHolder> {
    ...
    public AuroraToniMaticevski(ArrayList<AuroraSusienChong> arrayList, Context mcContext) {
        ...
        try {
            ...
            if (files != null) {
                for (String file : files) {
                    arrayListPrev.add(new AuroraSusienChong("color/prev/" + file));
                }
            }
        } catch (IOException e) {
            e.printStackTrace();
