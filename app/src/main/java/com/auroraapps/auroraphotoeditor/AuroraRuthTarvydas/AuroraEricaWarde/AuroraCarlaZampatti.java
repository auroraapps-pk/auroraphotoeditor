...
public class AuroraCarlaZampatti extends RecyclerView.Adapter<AuroraCarlaZampatti.MyViewHolder> {
    ...
    public AuroraCarlaZampatti(ArrayList<AuroraSusienChong> data, Context mContext) {
            ...
            textView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    try {
                        ...
                        AuroraVeroniqueBranquinho.textbubble.setTypeface(typeface);
