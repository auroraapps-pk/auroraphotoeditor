...
public class AuroraScaleGestureDetector {
    ...
    public interface OnScaleGestureListener {
        ...
        public void onScaleEnd(View view, AuroraScaleGestureDetector detector);
    }
    ...
    private AuroraVector2D mCurrSpanVector;
    ...
    public AuroraScaleGestureDetector(OnScaleGestureListener listener) {
        mListener = listener;
        mCurrSpanVector = new AuroraVector2D();
    }
    ...
    public AuroraVector2D getCurrentSpanVector() {
