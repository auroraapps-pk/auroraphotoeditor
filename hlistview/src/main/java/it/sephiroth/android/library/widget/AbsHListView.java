...
public abstract class AbsHListView extends AdapterView<ListAdapter> implements ViewTreeObserver.OnGlobalLayoutListener,
	 ...
	 * {@link #CHOICE_MODE_NONE} and the adapter has stable IDs. ({@link android.widget.ListAdapter#hasStableIds()} == {@code true})
	 * 
	...
	/**
	 * Set a {@link it.sephiroth.android.library.util.v11.MultiChoiceModeListener} that will manage the lifecycle of the selection {@link android.view.ActionMode}. Only used when the
	 ...
	 * {@link android.view.MotionEvent#ACTION_SCROLL}.
	 *
	 ...
	 * affect any existing background drawable set on this view ( typically set via {@link #setBackgroundDrawable(android.graphics.drawable.Drawable)}).
	 *
	 * @param color
