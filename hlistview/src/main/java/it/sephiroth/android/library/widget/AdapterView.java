...
public abstract class AdapterView<T extends Adapter> extends ViewGroup {
	...
	/**
	 * The item view type returned by {@link android.widget.Adapter#getItemViewType(int)} when the adapter does not want the item's view recycled.
	 */
	public static final int ITEM_VIEW_TYPE_IGNORE = -1;

	/**
	 * The item view type returned by {@link android.widget.Adapter#getItemViewType(int)} when the item is a header or footer.
	 */
	 ...
	 * {@link android.view.View.OnCreateContextMenuListener#onCreateContextMenu(android.view.ContextMenu, android.view.View, android.view.ContextMenu.ContextMenuInfo) } callback when a
