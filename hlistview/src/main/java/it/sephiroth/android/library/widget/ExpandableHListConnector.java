...
class ExpandableHListConnector extends BaseAdapter implements Filterable {
	 ...
	 * and group/child positions. See {@link it.sephiroth.android.library.widget.ExpandableHListConnector.GroupMetadata}.
	 */
	 ...
	 * position encompassed in a {@link it.sephiroth.android.library.widget.ExpandableHListConnector.PositionMetadata} object
	 ...
	 * position.
	 *
	 * @param pos a {@link it.sephiroth.android.library.widget.ExpandableHListPosition} representing either a group position
	 *            or child position
	 * @return the flat list position encompassed in a {@link it.sephiroth.android.library.widget.ExpandableHListConnector.PositionMetadata}
	 ...
	 * @see it.sephiroth.android.library.widget.AdapterView#findSyncPosition()
	 */
	...
	static public class PositionMetadata {
		...
		/**
		 * Use {@link #obtain(int, int, int, int, it.sephiroth.android.library.widget.ExpandableHListConnector.GroupMetadata, int)}
		 */
