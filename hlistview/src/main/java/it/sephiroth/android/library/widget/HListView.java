...
/**
 * A view that shows items in a vertically scrolling list. The items come from the {@link android.widget.ListAdapter} associated with this view.
 * 
 * <p>
...
public class HListView extends AbsHListView {
	 ...
	 * {@link #setAdapter(android.widget.ListAdapter)} but might be a {@link android.widget.WrapperListAdapter}.
	 * 
	 ...
	 *           The height measure spec to be given to a child's {@link android.view.View#measure(int, int)}.
	 * @param startPosition
	 ...
	 * height as set by {@link #setDivider(android.graphics.drawable.Drawable)}
	 * 
	 * @param height
